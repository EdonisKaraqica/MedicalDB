...
class createPDF
{
    ...
    function __construct($post)
    {
        ...
        $this->TAinput=$_POST['ta'];
        $this->pulsiInput=$_POST['pulsi'];
        $this->spoInput=$_POST['spo2']." %";
        ...
        $this->diagnozaInput=$_POST['diagnoza'];
        $this->rp=$_POST['rp'];
        ...
        $this->entiInput=$_POST['enti'];
        $this->ditaPareInput=$_POST['fillimi'];
