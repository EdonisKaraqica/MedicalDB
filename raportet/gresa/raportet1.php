               ...
               <div class="card">
                  <div style="clear:left; float:left">
                     ...
                     <?php if(isset($_GET['id']))
                     {
                      ...
                      $sql2 = "UPDATE tblkerkesat set approved=1 where kid='" . $_GET['kidselect'] . "'";
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="col-md-1 control-label" for="Emri">Ekzaminimi fiskal
                                    ...
                                    <div class="step-content" style="height:auto">
                                       <div class="row">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="input-field col-md-4">
                                                   <input name="fillimi" id="fillimi" type="text" class="form-control timepicker">
                                             </div>
                                          </div>
                                       </div>
